...
ent1 = Entry(window, bd=3, bg="purple", justify="center")
ent1.grid(row=0,column=0)
ent1.insert(0,"row 0,column 0")

ent2 = Entry(window,bd=3, bg="purple", justify="center")
ent2.grid(row=0, column = 1)
ent2.insert(0,"row 0, column 1")

ent3 = Entry(window,bd=3, bg="purple", justify="center")
...
ent7 = Entry(window,bd=3, bg="purple", justify="center")
ent7.grid(row=2, column = 0)
ent7.insert(0,"row 2, column 0")

ent8 = Entry(window,bd=3, bg="purple", justify="center")
ent8.grid(row=2, column = 1)
ent8.insert(0,"row 2, column 1")

ent9 = Entry(window,bd=3, bg="purple", justify="center")
